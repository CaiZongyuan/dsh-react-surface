...
Use Bun for dependency installation, scripts, builds, and tests. Keep DSH `0.1.5-alpha.1` as the compatibility baseline until a deliberate cohort change includes a real browser mount.
